        ...
        <form action="{{route('products.update',$product['id'])}}" method="POST" class="px-md-5" enctype="multipart/form-data">
         ...
         @method('put')
          <div class="form-group mb-3 row">
            ...
            <div class="col-md-10">
              <input type="text" placeholder="Insert product title" class="form-control py-2" name="title" value='{{old("title",$product["title"])}}' />
              @error('title')
          ...
          <div class="form-group mb-3 row">
            ...
            <div class="col-md-10">
              <textarea name="shortDescription" id="description" cols="30" rows="5" class="form-control py-2">{{old("shortDescription",$product["shortDescription"])}}</textarea>
