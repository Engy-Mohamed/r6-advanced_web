      ...
      <div class="bg-light p-5 rounded">
        ...
        @csrf 
          ...
          <div class="form-group mb-3 row">
            ...
            <div class="col-md-10">
              <textarea name="description" id="description" cols="30" rows="5" class="form-control py-2">{{old("description",$car["description"])}}</textarea>
              @error('description')
              <div class="alert alert-warning">{{$message}}</div>
              @enderror
            </div>
          ...
          <hr>
          <div class="form-group mb-3 row">
            <label for="time_From" class="form-label col-md-2 fw-bold text-md-end">Car Image:</label>
            <div class="col-md-10">
