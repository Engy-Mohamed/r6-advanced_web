      ...
      <div class="bg-light p-5 rounded">
        ...
        @csrf 
          <div class="form-group mb-3 row">
            ...
            <div class="col-md-10">
              <input type="text" placeholder="Enter the product title" class="form-control py-2" name="title" value="{{old('title')}}" />
              @error('title')
          ...
          <div class="form-group mb-3 row">
            <label for="description" class="form-label col-md-2 fw-bold text-md-end">Short Description:</label>
            <div class="col-md-10">
              <textarea name="shortDescription" id="shortDescription" cols="30" rows="5" class="form-control py-2">{{old('shortDescription')}}</textarea>
          ...
          <hr>
          <div class="form-group mb-3 row">
            <label for="time_From" class="form-label col-md-2 fw-bold text-md-end">Product Image:</label>
            <div class="col-md-10">
